				...
				faq: {
					"upgrading-from-evalv2-to-evalv3": {
						page: {
							cache: {
								upload: {
									"main.go":                 "k0ZTgmXvW4ElEG+wVz7c0ENwYRs6Bacsu3APfUmEoaU="
									"HIDDEN: required output": "dI04JL2FMZPglufTdudEJQRQuO9wyMVFvXYjRw+XAHc="
								}
								multi_step: {
									hash:       "RTOCTI7ON87GNHDOOTR7VQ7GK6E3JS1V44JSQ43HRK1JNI5UDKV0===="
