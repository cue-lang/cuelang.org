...
command at version `v0.11.0-alpha.1` or later. Here's how to use `cue fix`,
given the following CUE that requires updating:
...
The commands on this page use the following version of `cue`:
