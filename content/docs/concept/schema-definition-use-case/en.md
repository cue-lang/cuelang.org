...
This is used in [CUE's OpenAPI generator](/docs/integrations/openapi), <!-- FIXME: URL -->
for instance.
...
# FIXME: why is a command needed here at all?
# Without it, the preprocessor reports
#  "failed to build effective comment"
exec true
-- example.cue --
// Definitions.
