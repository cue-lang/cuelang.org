...
{{{with _script "en" "HIDDEN_ move api.pet.yaml sideways"}}}
...
{{{with _script "en" "HIDDEN_ diff api.pet.yaml"}}}
diff api.pet.yaml .api.pet.yaml
...
{{{with _script "en" "HIDDEN_ move api.pet.cue sideways"}}}
...
{{{with _script "en" "HIDDEN_ diff api.pet.cue"}}}
diff api.pet.cue .api.pet.cue
