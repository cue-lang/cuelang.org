					...
					page: {
						cache: {
							upload: {
								...
								"load non-cue - main.go":     "djAE3bnoyXagSYXyi+b/JDzE6BuGMRslQ+4+uE84lzg="
								"load non-cue - yaml file":   "nvkOkHiMDYIFNSTDsfqSVllX2zmvTUTcNcD23MYliTo="
								"check go data - cue schema": "H8nEBzKqAgJTckQb4bW5hsBrVL4BgtUnFPUv4FNsP4c="
								"check go data - main.go":    "y/UuACjiMjsgHMBN9TmNCY0IJHkBPYZ3sUkkksytOZE="
							}
							multi_step: {
								"NDMVB24N6SH48TRACA2I7ESF1VJ32HDV1DNRM0EOS4HCGH7UFDHG====": [{
									doc:      ""
									cmd:      "export LC_ALL=C"
									exitCode: 0
									output:   ""
