				...
				cldd: {
					"k8s-io-moving-from-cue-get-go-to-central-registry": {
						page: {
							cache: {
								upload: {
									"manifest pre":  "/Gd7Vh+i9ZHh/Gk50R4/Ss9TdV++pYHPuehGmwEZyIY="
									"manifest post": "QQfqGDJ4Hd+ThHVqnGRcYjstbjeT5mLVZXPH+0uPQJI="
								}
								multi_step: {
									hash:       "2SMMN36824KTJRL44CRMEL6AGKB90UU1LEBPBQF5IE6O8VV158V0===="
									scriptHash: "6915VKE8OLGQ0JJQE0OQ1TO6J21EVGNAN0QNTTKGS65SS7UJT940===="
									steps: [{
										doc:      "# Caches."
