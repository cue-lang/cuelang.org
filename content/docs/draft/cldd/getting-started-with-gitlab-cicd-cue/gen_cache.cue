				...
				cldd: {
					"getting-started-with-gitlab-cicd-cue": {
						page: {
							cache: {
								upload: {
									"1":  "u+9EGwwxLhluwM95gWZcU0V3sxtHzsl9PHn+bPcmEWo="
									yaml: "VTA8ZDJBATYj5i/LickZiRf1NnY2RbFAhUM+30wXOTg="
								}
								multi_step: {
									hash:       "5OFAFICTQ2F06RO93MEBE9AIOF0F04S3QGUKE293Q3CB3NOMFA10===="
