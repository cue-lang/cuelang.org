				...
				cldd: {
					"getting-started-with-gitlab-cicd-cue": {
						page: {
							cache: {
								upload: {
									"1":  "1I63oJ967O3CS+ciuFqZ5sG1rsGrxx1tsjCROHfoAJQ="
									yaml: "vbVerxo4ungRiPhQr5TlYAHJPXC1VK99C/PxrJPHmnA="
								}
								multi_step: {
									hash:       "IVP68NUPI1K3H2TS10RDPTCQ1J5757FKQC9E4SQFKGOOD0ACR8GG===="
