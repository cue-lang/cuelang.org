				...
				cldd: {
					"checking-existing-argo-workflows-files": {
						page: {
							cache: {
								upload: {
									workflow: "FiDaR4b0/Y7u9/qGrc4FwoUr8XlPvA+RrkEA1ScAhjU="
								}
								multi_step: {
									hash:       "BEGIOKT82DHC1LC7LL1T5G42NNEEIQ590H4TB7HSENOACSQOGV8G===="
									scriptHash: "VMIVM16MP7AOF6JUE23EPV5RVLG8PCTNKMG2OVIS07MUF24GGTG0===="
									steps: [{
										doc:      "# Registry auth"
