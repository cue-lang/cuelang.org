				...
				cldd: {
					"spotting-errors-earlier-github-actions-files": {
						page: {
							cache: {
								upload: {
									broken: "MW5L+dx1PRNmaat0FJUU3rpOH0AaAdfxYjwzF5sMwOo="
									fixed:  "HDrmsq98WiNAnwgMLbDBzmJZR0ygBOOsTI/MUnQ5ewM="
								}
								multi_step: {
									hash:       "1NIPVVRAQ6EUCOQ2C2O1I3278CRF0MLU3R5L9OAFV0A3SA2K5V40===="
