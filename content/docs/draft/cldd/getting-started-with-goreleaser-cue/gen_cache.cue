				...
				cldd: {
					"getting-started-with-goreleaser-cue": {
						page: {
							cache: {
								upload: {
									"1":  "SQ3DpX7oBix9YmTn2es6ACOEYdd9xwcyscSzhRJbCmA="
									yaml: "mMZaORfayhx5RQ0Cfkwwtru56quGvm2CuaZl5zD+ztQ="
								}
								multi_step: {
									hash:       "RE6UH81HEGOEOMNUM1M0C0J8PFJBOFD0TNP87U3AJCK2KT0ODLQG===="
