				...
				cldd: {
					"getting-started-with-kubernetes-cue": {
						page: {
							cache: {
								upload: {
									"1":  "5oUtEfUroWhp38Hx/hD3VzjG5nYzJPrbaj1nsaUsZwk="
									yaml: "UnLknNKVrpw6SxRXwruuXOphCPA0tFQpGU+qGFgI1Bg="
								}
								multi_step: {
									hash:       "78H4H32I05PAEU85KGF8P0EC4ILBT6RBTN5H07KBGR1GKGD7SPAG===="
