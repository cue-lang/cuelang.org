				...
				cldd: {
					"getting-started-with-docker-compose-cue": {
						page: {
							cache: {
								upload: {
									"1":  "fey/460RUUzFuSkXGScgszc0XuZGsnikfnDSzWHjFxU="
									yaml: "DSvYka+iW2pomwAzZbKrlT24JWrFhR8uCCH0+QzUOZY="
								}
								multi_step: {
									hash:       "TSU5L0VV8L3BQUJMOV38D6R3IMB2LGIPJC8S0LUIALKGTMPEJSPG===="
