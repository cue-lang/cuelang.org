				...
				cldd: {
					"getting-started-with-docker-compose-cue": {
						page: {
							cache: {
								upload: {
									"1":  "mAXVriIuPdha0dF+3N9y5BSgbWWFWm7uxbCwsQe7GI8="
									yaml: "Sg43uw2OxeagsZ7V+6NJWDl2n3u3/A/CysC1ErGz3Fk="
								}
								multi_step: {
									hash:       "MJ5G1SL6EDJDB3FE5C6V8D50NMKLU1U3U4VDLVK324PBER8NML60===="
