				...
				cldd: {
					"getting-started-with-buildkite-cue": {
						page: {
							cache: {
								upload: {
									"1":  "TG/qoxsqh3ZbiQppH1ayWwCaljZoLK5bcJj9SPMWCb0="
									yaml: "5uN8X5u7ZhXnV5QeYgT92hhov+2BpcEjC/TZ3s9RvoU="
								}
								multi_step: {
									hash:       "9MMT73L2BR35R6SQQJGCG5N0PMI0GRJ070LV3MKQR0HGQ454L5C0===="
