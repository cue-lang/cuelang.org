				...
				cldd: {
					"getting-started-with-github-actions-cue": {
						page: {
							cache: {
								upload: {
									"1":  "Ul04xET86YqakRAPUcEXvEfmcvtPpp1QEVRmrCC1i/8="
									yaml: "I9UpBc46jSSmAsS4eKvfD3G1t2qQF2ISRYXFxdLq0yI="
								}
								multi_step: {
									hash:       "SJGC19TAIJOKER653D3H9HLA460CHCN6H24RDB029052V4BP4MU0===="
