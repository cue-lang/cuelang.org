				...
				cldd: {
					"getting-started-with-github-actions-cue": {
						page: {
							cache: {
								upload: {
									"1":  "O07aqFnzUYZVZPKCb2VM4MKVFD4WlU21+k7iEDTq3gA="
									yaml: "SBt0sfX2n8kffNcrvnFljXEaPclaCk56HIoii2x9Uhs="
								}
								multi_step: {
									hash:       "Q3FDROV7IH5RE7VEIV26JBRKSNRBSGAPFI0COP5MT40S93F7BG50===="
