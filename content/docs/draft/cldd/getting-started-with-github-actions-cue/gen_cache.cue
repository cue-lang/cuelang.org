				...
				cldd: {
					"getting-started-with-github-actions-cue": {
						page: {
							cache: {
								upload: {
									"1":  "+aQGgvPMmeN0hVeYqTydRs2+zYNl1iH7iQ8RE3jY2qw="
									yaml: "JyGC8B78sMIUh/KISjIwe3vFaQ+FN0vPPSLcm0Vkfm8="
								}
								multi_step: {
									hash:       "ROQF2NJ6R2M8JF9CMJPVFLOKFHCUVVGQAIIH9PIL7E2NJ6LNOLU0===="
									scriptHash: "328O3E0L4HHI09CGAOTEIUKF2SQH32CO2RLD0M5TI8D4ITCNP9T0===="
									steps: [{
										doc:      "# Registry auth"
