				...
				cldd: {
					"spotting-errors-earlier-goreleaser-files": {
						page: {
							cache: {
								upload: {
									broken: "TCIkXJZhuQXAZEWH46ksfEpNI7bpyTNENDrXwpzfADE="
									fixed:  "5AdBS0B7/m8NwzAXLD4aw0R5c1FUFdYY6tqiZX6PQuk="
								}
								multi_step: {
									hash:       "6VG8RBSD4QGFLMH1LCGPNQKG3V928SR05VE6SIH4U46BFTP4OKEG===="
