...
{{{with script "en" "cuelang.org setup"}}}
# Required because v0.10.0 suffers from https://cuelang.org/issue/3462.
...
find .
cue version
cue help cmd regenerate ./internal/ci/github
cue help cmd regenerate ./internal/ci/github | head -4 >../12.actual.txt # the "./" prefix is required
{{{end}}}
