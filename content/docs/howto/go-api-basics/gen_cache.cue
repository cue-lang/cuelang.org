			...
			howto: {
				"go-api-basics": {
					page: {
						cache: {
							upload: {
								"initial cue code": "EF2nv1maCwhBJPdjfj1wp+YE7Jz0fgamfaU18c+HjhY="
								"initial go code":  "lRihqqNMWkOG7u3XV54SGXBZ7eAtKWKIGt5y5IG1KUM="
							}
							multi_step: {
								"DMJG6T4P6E52IM370SF0L99QC8Q0FNQ98UBURM5M4T4SCDQEH4VG====": [{
									doc:      ""
