			...
			howto: {
				"build-cue-api-java-jar": {
					page: {
						cache: {
							upload: {
								"HIDDEN: configure Maven download cache": "rf1kYSW3+3QwGut8dnGU8e6ifUEEfRr32Vp8nrUixBs="
								"test load":                              "DHqBuQcWPcmJt52H9WXwohdmVPn8y098V8cxidY72pc="
							}
							multi_step: {
								hash:       "7VPOD2O1PJESOE9INK00FR79VRJAJ44MOEB7LJLLBN8T9N7SLRMG===="
