			...
			howto: {
				"validate-go-cuego": {
					page: {
						cache: {
							upload: {
								"main.go": "Xv2CvFB9nUWDNS1xEiAUav97C+V+F+xl7WIdL7gTRW0="
							}
							multi_step: {
								hash:       "22UMPN0R5EMVUUJUEHTNND5DDKP0DQFNMIRPM1HHFUVDSPFCGGAG===="
								scriptHash: "QTHGFC9F3PPD84NJUK3T870OHC2NKN6OCG4TKS656U8N0CGRASTG===="
								steps: [{
									doc:      ""
