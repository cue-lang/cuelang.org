			...
			howto: {
				"validate-go-cuego": {
					page: {
						cache: {
							upload: {
								"main.go": "SyKeKJqg6gHh5/bVj0see79BJmNwA2JVkTeOac1UEto="
							}
							multi_step: {
								hash:       "JQ0NEFHBLATSLP1NMGRB50VN2VRUFS4VBTEHQK306DM01VU41PPG===="
								scriptHash: "OU2EHCD21IQKEBHL980UIIK5P8JQFESO7LCQ43HM6LAOR5ABT900===="
								steps: [{
									doc:      ""
