			...
			howto: {
				"validate-go-cuego": {
					page: {
						cache: {
							upload: {
								"main.go": "2VpKEzvIGqFDi4Lyn5ODXAae1gUPuaoT6yjMOtGw4n0="
							}
							multi_step: {
								hash:       "RJTAJ8NPBE8AVM1FNLTFL31IGGLKANC1DCOJ8HQ2EKJ443DBT6NG===="
								scriptHash: "FI0C22M0IKLDQH0B92J0HN6ICQ03E8GD2JR5PUC66IGT4TEADB2G===="
								steps: [{
									doc:      ""
