			...
			howto: {
				"validate-go-cuego": {
					page: {
						cache: {
							upload: {
								"main.go": "n68bPq6+MeRV4+R4x2DaQ+g99VwfbcPVe0COb2ynrO8="
							}
							multi_step: {
								hash:       "8GCFDLFV5RNTNP2VANN3OPJCDA6ML5A47EST66P4RNQFAHRNA9DG===="
								scriptHash: "H2CPTHFDES5LFAFNE977277E03C8PP3PK0S60EFJ3J6KBGLG2MV0===="
								steps: [{
									doc:      ""
