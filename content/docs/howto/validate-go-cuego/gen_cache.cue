			...
			howto: {
				"validate-go-cuego": {
					page: {
						cache: {
							upload: {
								"main.go": "wG0gh02bQBw3hJlv+RV0wEWm3EeBsD4sNvBaBOoDAmg="
							}
							multi_step: {
								hash:       "2CKO3QU5QG03TCNBKEIQHR9ASEG1CAF7D2EK5GILLOJ8FE24L2H0===="
								scriptHash: "SQV5VIPC7HCM0CM1LUN9F2L3RDAN7FDB7OM7AC3KP7HVI7DHMSU0===="
								steps: [{
									doc:      ""
