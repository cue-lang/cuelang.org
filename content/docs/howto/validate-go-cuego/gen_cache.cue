			...
			howto: {
				"validate-go-cuego": {
					page: {
						cache: {
							upload: {
								"main.go": "q/zxitkkopKh3pGwCRqYt7gQZ2bLH1Vy/2lYRq4PkZg="
							}
							multi_step: {
								hash:       "LGO08RJL82R7BENDBBFMK420JIH9SMHLLJRMQACTDQA2HVTUOT10===="
								scriptHash: "0VMHB3NNB15NVBLA2D5P70CQV8I7E0B01KV1GQACVC3B629JHMN0===="
								steps: [{
									doc:      ""
