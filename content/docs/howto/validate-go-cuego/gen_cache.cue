			...
			howto: {
				"validate-go-cuego": {
					page: {
						cache: {
							upload: {
								"main.go": "jSRKtd5p4PTN576op8vvfLrCcrBk9DNL0P7ZvkhcYpE="
							}
							multi_step: {
								hash:       "5ICB79JN1T482T1A46EAAUCSITM11M9MOC4B7TD6QAUE9F8OIOV0===="
								scriptHash: "9HNRRE1EQGBHPROIC1L3KMF9VPS07609HBF7ML93QBCUMPE0V5P0===="
								steps: [{
									doc:      ""
