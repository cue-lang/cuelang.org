			...
			howto: {
				"validate-go-cuego": {
					page: {
						cache: {
							upload: {
								"main.go": "58aTtDJkkcYRFGPu2hKbsStFdQehPCqKhlyJVeaEUkE="
							}
							multi_step: {
								hash:       "U9CI7LL4JP8G1E0S5OI8CHA043O4TIGDCNKGJBFKOA08A2TSUD10===="
								scriptHash: "4PK57737NBNHL9JNSRUTQ9PB756HVDFBMI1FJN5FK085V6FGR7EG===="
								steps: [{
									doc:      ""
