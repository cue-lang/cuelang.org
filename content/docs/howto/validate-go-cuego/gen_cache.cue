			...
			howto: {
				"validate-go-cuego": {
					page: {
						cache: {
							upload: {
								"main.go": "Exd2wj0abil1ZW8y8CDKmnSVeAQf8RINUfVOgs9J7H0="
							}
							multi_step: {
								hash:       "39UCA470PCFMHDC08SQF435JD3KU091FBIOEU1NIBACEN48HI6O0===="
								scriptHash: "UD5DLLFT8DHKORH85KRI072M1AFSUKP3CMUFAKDK4OPCU0K79QBG===="
								steps: [{
									doc:      ""
