			...
			howto: {
				"validate-go-cuego": {
					page: {
						cache: {
							upload: {
								"main.go": "SF/laXdLJs0ThN4LWd1HRelg3KJZkjjDqPnLenDVJDY="
							}
							multi_step: {
								hash:       "GK8DV158BT3VGRKIHL1QMGN1291DJBIA2ELS84KG1OVT3B5J3DR0===="
								scriptHash: "VL00T0GVID46MOV0J7D7FK2MNC1J3SJ4LPFT69B5J0HGDRSGCFKG===="
								steps: [{
									doc:      ""
