			...
			howto: {
				"validate-go-cuego": {
					page: {
						cache: {
							upload: {
								"main.go": "To/cVDMkWPaAElktDaRT9Ehz05YIT9ZlaYDfwrgUgJM="
							}
							multi_step: {
								hash:       "PCD432LV4BLMQOTFJSE5D2JMUST7S6NTNMG8839KCIH360IPTKLG===="
								scriptHash: "DIVJSRRGVJC3DTQEDFRC8OUCAOKUOE0L9NQHICFLDLJV8J1NPFBG===="
								steps: [{
									doc:      ""
