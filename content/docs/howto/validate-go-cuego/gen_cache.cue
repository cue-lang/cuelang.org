			...
			howto: {
				"validate-go-cuego": {
					page: {
						cache: {
							upload: {
								"main.go": "UFWxHr53qpB6knAgwebbDEXL5AIp1TdPFVWoGivhMsI="
							}
							multi_step: {
								hash:       "863VK060H6UC98COESLT56I76KDFDSMJG9OUH5FVRMI9T6VFRMV0===="
								scriptHash: "BE9PP0B3DSSA76AMV5I9R6B4CK0QPG11CBQS47TTM1HBVB1G1V00===="
								steps: [{
									doc:      ""
