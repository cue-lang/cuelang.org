			...
			howto: {
				"validate-go-cuego": {
					page: {
						cache: {
							upload: {
								"main.go": "XueIJIYTACIw6o8v9a2PDHo5m9UojDFeW1IrJNCLiTU="
							}
							multi_step: {
								hash:       "J1297SOER1IHPEQKNVR4CIMTKJVFI29B99GR90TV67C5TCS105F0===="
								scriptHash: "SSRTGCVVMLBQHQQCQNUH4MDAL5ATJ07BK2BKIPGNNC9FE09EDFRG===="
								steps: [{
									doc:      ""
