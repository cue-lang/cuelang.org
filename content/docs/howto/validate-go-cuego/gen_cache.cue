			...
			howto: {
				"validate-go-cuego": {
					page: {
						cache: {
							upload: {
								"main.go": "8m/moYpgHazIT8FGFI+xJTHUwG/YstUgkrtoFNFkxSg="
							}
							multi_step: {
								hash:       "BSLTV4TNFPL0IJ4NO0L1KK512JDS9GKR4ACVNGRRB5HEBNK0K7L0===="
								scriptHash: "V97MMGMEBL615QP118ND8MBH90F438FFIOF45MJMPRL9GFQ3HIH0===="
								steps: [{
									doc:      ""
