			...
			howto: {
				"validate-go-cuego": {
					page: {
						cache: {
							upload: {
								"main.go": "rU4IToInDqcnsldyqRJ9+uSiJeXo+J9MQNbOSNkSPIo="
							}
							multi_step: {
								hash:       "RB9RL0BDVBVCNHKEQFLEND1MVTCJSI2M1SJ99FRGNAPGA31NN5PG===="
								scriptHash: "Q2U6HHCACHB2SVUMAV0RQ69G4C58FMO7RIC8BCUN6BBIKTC36U0G===="
								steps: [{
									doc:      ""
