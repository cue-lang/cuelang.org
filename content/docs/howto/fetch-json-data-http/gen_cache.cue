			...
			howto: {
				"fetch-json-data-http": {
					page: {
						cache: {
							upload: {
								"HIDDEN: server.go": "e5ieoC5cOwwneVlq8S4aU84nrx3duDwaUMLWkR9q3Gc="
								cc:                  "Iia3L92Zkdcv8Mo3E7i/LmdbrytDT+SQ2asSDsLJn2w="
							}
							multi_step: {
								hash:       "FA3593S6LOQQ2EG0PG3HGDFDA2BV0C6QLS7PMKHVELFMG9CSUFH0===="
