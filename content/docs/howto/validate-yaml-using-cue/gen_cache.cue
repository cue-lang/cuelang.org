		...
		docs: {
			howto: {
				"validate-yaml-using-cue": {
					cache: {
						upload: {
							"initial x.yaml": "bN7JY21dwVUUIdBEI+DSVMlje8m8yqYlKLHXKmgw/+A="
							"initial x.cue":  "Q5ypbMXKHbUeb8rTiobgHJtbQYh7l6VvlLS6hMHTMcc="
							"another person": "x4MILTKyIqST3cmemjYfVBDD7BoIZ00OC8tB8a70FSQ="
							"fixed yaml":     "QBSpjG2Alhl64VUqK2w9Xvri3KDJssbwonAVMNEDmTg="
						}
						multi_step: {
