		...
		docs: {
			howto: {
				"validate-yaml-using-cue": {
					cache: {
						upload: {
							"initial x.yaml": "x3w69w49amMM9nHP+w33YKbFdUD4D1ug/5wHnms6tFA="
							"initial x.cue":  "seqaeQvPa87je1dGbOvzbAWnMSLiUJauiF8iJJ9+DUU="
							"another person": "EeL7nx6g8yJgQm3q/miEvwUVChM4gEZBRa4pkXqoVuE="
							"fixed yaml":     "XHYUTAc7HRfrQhCOb/FmjNbBI441VnKhFhRy7K9vhcg="
						}
						multi_step: {
