		...
		docs: {
			howto: {
				"validate-yaml-using-cue": {
					cache: {
						upload: {
							"initial x.yaml": "CcH0U0C+X2mWOJcwPhA2iW/DqsRUq7pDPnkR85fP9dE="
							"initial x.cue":  "9ukmmRIcV/jae5x0NTuLEpTlrTZ4UV+ZguhnMJOBcoY="
							"another person": "jA+365lXWNLBvCLDFZ/1oV47GlAbVIpRiJEzKdShmqU="
							"fixed yaml":     "ZqM01Oeki8wvyCqFciD+AtCDqJSLJOwzyFbvuiVv5SY="
						}
						multi_step: {
