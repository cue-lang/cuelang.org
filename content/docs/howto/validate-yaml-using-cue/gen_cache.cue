			...
			howto: {
				"validate-yaml-using-cue": {
					"_page": {
						cache: {
							upload: {
								"initial x.yaml": "CB2ra8dV1gF6AB/btp4oq3u4XaRgbD/U6UP+TrR/hqw="
								"initial x.cue":  "YPSI4OJQx0Ixnes/vSGadJ/1Wz0ajFLFQ6K6uHoX0Z4="
								"another person": "sGYEcpm5OYXge/pmJXvS93r4J840Grv04tFu8AiIqcY="
								"fixed yaml":     "Dw8sHgg844YgAMEz1kkhlPKOd9f6WnUkynlN07EqYbE="
							}
							multi_step: {
