		...
		docs: {
			howto: {
				"validate-yaml-using-cue": {
					cache: {
						upload: {
							"initial x.yaml": "FjtHvCPXLTCRznSLVYdV/ty3dKT7C92D/6BZEm0Q4G8="
							"initial x.cue":  "IylCd4FToilo7q+f9s6rvNa3XhEGBowAoQFPNDlTsgg="
							"another person": "1HF4sjgJBnqYZ/Zs1/IauFQ/kO9nus+UXcxonzmAzB8="
							"fixed yaml":     "s3drQOIlx8goVjBkUQNYYEaOgFm9jHy+4Wuwg6hRMbg="
						}
						multi_step: {
