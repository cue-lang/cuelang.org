...
- You have `curl` installed, or can fetch a file from a website some other way.
...
Copy this CUE into place, and then adapt the elements commented with `TODO`:
...
Make the modifications indicated by `TODO` comments and delete the comments.
