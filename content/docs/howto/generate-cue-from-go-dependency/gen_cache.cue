			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "8A7UWO+7VR5223yDbG2HOze67xrVsxFZHm5/hxrPGdM="
								"example.cue": "OpUIzAO/V77PLcGWN4s31yODBhHg3e3gp8LKUEmFTJQ="
							}
							multi_step: {
								hash:       "CI02RDC25160KP2PDGM10IMTQB3LUB47P15FN9P2AEAQAGOQ2360===="
