			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "OrKHNsShvvwiYZHUWNbmpbnxnSAa/vjYOhzmlpIHnPs="
								"example.cue": "h8Afjr5Nq8kATTpidmGkJxGzO/JcCT0IhLNKfGaqtvA="
							}
							multi_step: {
								hash:       "04DJJJFBMC1RA6SV8FDNAVR3U9NHK85JAS7UDT2DTJVS00B1R59G===="
