			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "UKdn7NWcSy2DSWpB/Os4eTQLpBY9EbEsld34nUru77s="
								"example.cue": "VWMClrsge2top/uWMLHIj/gXoEYi1XuaScnq9XsBMFA="
							}
							multi_step: {
								hash:       "77VCU70M5G03A18AF52BC6J1O87UVQP0QK2IU9DDL64H1FHUUMNG===="
