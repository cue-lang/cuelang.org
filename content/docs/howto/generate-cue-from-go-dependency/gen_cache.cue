			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "mktp9XwclRU0MAkR/hzznUtn/cV3hF+ohWnzOW0ueV0="
								"example.cue": "HyqHVbZY2WRtgIHC2n+XnroxRtwEtROtTyGvX8uVFYI="
							}
							multi_step: {
								hash:       "GST0U4A6JGV92LTHCN4JQOTPON1SO4NNS1E8Q3TUQAPKF9E7SDM0===="
