			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "PV1yKfJ6/MKYdKW3M/fyazKuY2AeDx7/hpm9nEpWfmg="
								"example.cue": "L5bMgLm1PRyZGiOEcTiEjdqrgSUtOZUcnVJa8pz9dNM="
							}
							multi_step: {
								hash:       "QOCO586SEGRF7IL6SC6OICK5IR9HNIF0J70MHRBOEAL4UB1BA9LG===="
