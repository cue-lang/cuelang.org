			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "WBgZLsPugp5tb0mneYA/MuZa7ByRS1zrGEQ4h7YXyUk="
								"example.cue": "E41OC8K8zSmRZ2ix2LTnrLjPWzFoPtvY5rWyELTiUko="
							}
							multi_step: {
								hash:       "A3PVPG1RAR1NP4EM7V14E0F8VTDVGE16GE30B2JB4FJUT006QMUG===="
