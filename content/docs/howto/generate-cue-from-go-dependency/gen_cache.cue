			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "AZBdaqMt5Wm4KRsSi9wC+gzsnWlUkVNJoh6bjGdcTVM="
								"example.cue": "6BcJWhy4jctJUO1Z4yni/EovVojl1x0R3pczv5tgGUo="
							}
							multi_step: {
								hash:       "VMECLJK09OCE00JECQG3A2GF3DN9P9LKTUF4OUB692UDF013QM6G===="
