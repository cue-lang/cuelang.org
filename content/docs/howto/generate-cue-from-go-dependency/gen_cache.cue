			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "+xiWqcT52/o8W/WSl+AYzuc+YksTQcc138Q5UNYSDDY="
								"example.cue": "fcdhU92MJmF2v7po2W/mBEQ5M+/CrSWN4QXf9xhAa6A="
							}
							multi_step: {
								hash:       "NIDRFDK8HK62UKL58IQCUCPE8TI63HEGJBEOPJP8BMGV567D4T6G===="
