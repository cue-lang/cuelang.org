			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "3JjHfLXcCkSfUllcvuUJsgn4q2iCozX+0yodmKFLaz8="
								"example.cue": "C48Da6+mhA2ndB+4LQ7QKSqpINUt18MFxa2KusBQX24="
							}
							multi_step: {
								hash:       "F2BKI6KVTV15BLRRO0SOHA5STCQUQ0AAMFOB6SJA32T225NQMHI0===="
