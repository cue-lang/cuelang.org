			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "JPZzVDZsePWn7D/zmwWN0/2xQZMvRkCO4iJnlqOmB6s="
								"example.cue": "73jZRW9466qe9Nqf12flDpgOhEjC2ukdgH0deVdAU2o="
							}
							multi_step: {
								hash:       "2HBI1FJTD976KLCO9E924VM1R5KB7CC94G8O4FHDSIT7S2ISP0S0===="
