			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "xI3LXqVT7/0khZCuYvjSA8lcEEndIUF9WmwQ/xmwk+U="
								"example.cue": "FEGQ3YgYJVc5vdPIfie/66LuxoLBWIpDa/4HBpvY9hQ="
							}
							multi_step: {
								hash:       "557U4O87C83O1TK5K6QCGN13M7ESQRMDQPM1M2D6HM3NNORTBR90===="
