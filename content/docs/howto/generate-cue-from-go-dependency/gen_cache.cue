			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "PJlS2eStV52zmSuETwfPTW1pepJzQKIU4xafIPQ9wLI="
								"example.cue": "ZWpqrcGCdgd734w4YH6rlKaPkafqWcPplRdIvnATZ+Y="
							}
							multi_step: {
								hash:       "99FTO65N282NAB3066VIITGFRDR2QI3FAOMKOP1P1D417NNOL3SG===="
