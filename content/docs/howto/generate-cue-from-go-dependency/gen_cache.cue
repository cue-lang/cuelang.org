			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "rylHiP49eOcvh00AN6qgnspxmhQx9HooZXKJ672/nCI="
								"example.cue": "kSG0Ryt78ix+jYYg2R0o3S2Q06koMBRb2McnfZ2z40M="
							}
							multi_step: {
								hash:       "77B2C7P8MEU2GU5SI6NSJ64NJSSGILG51AVS0GT8LMU1EC1UJ43G===="
