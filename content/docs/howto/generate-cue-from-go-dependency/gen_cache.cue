			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "du0MSOPJ2SWdBe9NdtC/aKaF5OE4tsAIoRHZxjOyiNw="
								"example.cue": "QneQCer5N9hNVrbqCtBNm+AvrHypYhWSGV5vhbA+AK4="
							}
							multi_step: {
								hash:       "5933M01T1EOKB1MBETO514GT9S1OUJM9KB4V26FVBK06PPJAESC0===="
