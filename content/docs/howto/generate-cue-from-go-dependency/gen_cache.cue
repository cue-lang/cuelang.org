			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "jP3QIaoApTYRma1lEG+pOyi7kfd9YL2fyDoIV/+u7I0="
								"example.cue": "kFy0ci3fmSaoCbr7+BS0LT3pxAmLfnEVY85f1O7+fSs="
							}
							multi_step: {
								hash:       "MO4G9SAETT32TATU9RIF5SURUPSINK3EOFB7199FCKLKFE41URDG===="
