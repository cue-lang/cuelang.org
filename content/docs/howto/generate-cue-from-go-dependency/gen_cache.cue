			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "vxRL1+6DUzccvmT9x1XLItKvOb5F1oPbPBYTtUh3+cU="
								"example.cue": "3NKOiDbFC4HN8y6ffBi++8pjMvjncM7c4j3y+tArQFU="
							}
							multi_step: {
								hash:       "3TOPONGP49J0Q168IMIAFGVIJ5IAT4T15K9DEGHLI6B5TTLL4IIG===="
