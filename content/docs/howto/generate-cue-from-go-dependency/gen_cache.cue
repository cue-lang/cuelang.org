			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "FW7QkullP6e7aKMCM4xcxiVZuRaceYh/DrrjYaWLfNQ="
								"example.cue": "shonjGG1q/DxEAjbyOtKzapI7fUsL/nlJ1N3qCVxmcg="
							}
							multi_step: {
								hash:       "HE2EDAMA0HPBFBG5UET324RK3TEVN9F3NK8U1VBADK68OAM0637G===="
