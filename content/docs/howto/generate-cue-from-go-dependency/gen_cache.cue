			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "yPybYjhP5yboLwBACwZBnci7t0UovyxS1noR3kbXTGI="
								"example.cue": "OnycY+OjuccQvN1SEmeYW2KvlrlI6cwdBLzDztNlKnM="
							}
							multi_step: {
								hash:       "N5PTBJH5L571MUIKG72TH1EIGIEONN74C5FIC333NTTM766SUIR0===="
