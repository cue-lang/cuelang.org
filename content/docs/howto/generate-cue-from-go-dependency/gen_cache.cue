			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "WEekF8rXZqFBnenNzr37edZqlbfEFX2H6nNTb73Ea6k="
								"example.cue": "56Hec9YUSBPeu8PEVK/DSj9X9jdWGPO0wBFEO9T+4EE="
							}
							multi_step: {
								hash:       "CVHV11BE2PO27ADL8PE95RQ9FRM7M7OK4JH0C1V3A52A4U1VLJGG===="
