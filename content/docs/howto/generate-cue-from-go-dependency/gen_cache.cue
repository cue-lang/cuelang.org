			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "IhBI/vhx/5AH4FSAfHdis3RUry5CVfSAnftCqKG9CVw="
								"example.cue": "3vUZoNrt2BC9H6R8FMLbREjvUY/cVq+H8os5LMl/1os="
							}
							multi_step: {
								hash:       "5F2UG1UNKH964E08HGCG6IB5HC030R4QFS05Q2JN8P4PFUTO5PDG===="
