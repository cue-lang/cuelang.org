			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "cWL/LcjxuD6UkZTtewvXpSm7Y+ifuBTuS2xahEycb7A="
								"example.cue": "PCn+vzD+v2NWczZPJDiAwkbPiyTQiCrV++jLZy07IVc="
							}
							multi_step: {
								hash:       "FV9O17A9JF9GMUEUCHDUUPH6QSO8GHQ3BLJTUGUGK5GFP9681PM0===="
