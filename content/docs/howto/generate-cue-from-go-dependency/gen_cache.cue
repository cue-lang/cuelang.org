			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "Nqt5c+ooG7uXbFtuL4bgNvoUyagloPZdrq0HsqaCWOk="
								"example.cue": "J7+sIYRWAIyOZmANZXBidFtyEGJEIlXCcHkF2yp+QQE="
							}
							multi_step: {
								hash:       "M51QU1NFAAD2SLBHVSPA5MTHQLR9VNBTQRQRRQETNJ1V3J9N0IP0===="
