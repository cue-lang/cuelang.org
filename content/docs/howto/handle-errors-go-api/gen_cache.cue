			...
			howto: {
				"handle-errors-go-api": {
					page: {
						cache: {
							upload: {
								"initial cue code": "fHRmmLrMvJ9b9Vm5+eb1eb0iOIXebeicnOrnBWspFlA="
								"initial go code":  "5fq4bbZF0GgxppdRgA5pHYi01yWyggxNWok7++5hC40="
							}
							multi_step: {
								hash:       "HPBULT4LI300KP33SIMDLE8KU05NCLORSHKNCLNT9VGVDC1H637G===="
