			...
			howto: {
				"encode-json-yaml-with-cue": {
					page: {
						cache: {
							upload: {
								json: "lNvVW83xpon91Odx31gigMc/ndOlst9FzgPC9sD1Sig="
								yaml: "SGXGqMLNmrwhEgJyuJPL/3sDhNPob4/xQJDE69yij0Y="
							}
							multi_step: {
								hash:       "T56IBV9N8O3S63P8A44QIEJUVJIG121NVTGGUI0P236NOGA1IMH0===="
