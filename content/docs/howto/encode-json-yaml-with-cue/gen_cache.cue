			...
			howto: {
				"encode-json-yaml-with-cue": {
					page: {
						cache: {
							upload: {
								json: "DcBGqxZ6n/1diDscn+OokoOW869C5dpxtiTI7DPUMlQ="
								yaml: "ROQemh5wUSPRR99AlIlAueGw4KZz/z8Qo9FWAlPtgTc="
							}
							multi_step: {
								hash:       "SGT4A6QII2OPDP4D0V2V3C10P3UPU3M9U3PGAD15M5BK8E7PRHNG===="
