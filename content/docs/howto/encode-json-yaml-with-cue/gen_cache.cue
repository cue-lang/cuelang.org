			...
			howto: {
				"encode-json-yaml-with-cue": {
					page: {
						cache: {
							upload: {
								json: "YuF+o/vqK24MYSII3gBMTkAMFZBC1fSz6AmGiKXqRwU="
								yaml: "mgs+nr5OVvk6IQMMU49mkElpcnr5mbYK5UszZZxm2Yc="
							}
							multi_step: {
								hash:       "ONR0U517LRHBC27BOENABPJPMAISS1UKIIIRMPJ0BUDTQS1319PG===="
