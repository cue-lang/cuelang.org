			...
			howto: {
				"encode-json-yaml-with-cue": {
					page: {
						cache: {
							upload: {
								json: "e2i9Cgk5oodeIUPQiPEFkcaNpzF/ac2fyZ+LMRqWTIs="
								yaml: "XF9IeyOQ3mt5PyL0C0EbmoHuS0BMDA7CdqBOl0YVcxM="
							}
							multi_step: {
								hash:       "ML1CO2PO5989MAL15M5BTJG14VH8VVM50UPHFDQOL1BG6GTVLR2G===="
