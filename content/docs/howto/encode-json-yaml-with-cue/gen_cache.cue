			...
			howto: {
				"encode-json-yaml-with-cue": {
					page: {
						cache: {
							upload: {
								json: "m4pUM4t997+GjYBTHYE6SOhxR9Se3v0uiJlXgkrWvXo="
								yaml: "bXMLT99fZ8zL845GIR0+3K+8OZ8CGhuBfW2/M+LI8Fg="
							}
							multi_step: {
								hash:       "D60EDDCQBNAJA7LTPTQKLUNITP9P5LMLSGP8CLMLOEQ89UCFFBH0===="
