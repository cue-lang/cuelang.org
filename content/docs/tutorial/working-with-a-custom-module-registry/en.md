...
# This is inherently racey. But not a problem in practice... for now.
# When it does become a problem we can solve this properly using a
# nc-based wait loop or similar.
