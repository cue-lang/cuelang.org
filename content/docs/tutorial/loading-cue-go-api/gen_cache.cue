			...
			tutorial: {
				"loading-cue-go-api": {
					page: {
						cache: {
							upload: {
								"initial cue code": "tS33VW8o28L4nzTHIMxHqQUti2zRX2C4I0+mSOAgA+s="
								"initial go code":  "wT/SzVInarwcENqUoB9BOTjjM96MJRt0OK3eq6XWnLE="
							}
							multi_step: {
								hash:       "E92OJN44S8NVOP9IG2N592IPGTSGRBLIF8FTS2668ASD9GAMTTQG===="
