			...
			tutorial: {
				"loading-cue-go-api": {
					page: {
						cache: {
							upload: {
								"initial cue code": "mVDhtMcRxUHjacdTg1mGaTBiZHonRegRoMU1HcOMNUA="
								"initial go code":  "KEb5S1Y71q6olR+wyVIRk3POPklvE2x3QJi34Hu8qLw="
							}
							multi_step: {
								hash:       "RVVOLR7NIO7NTMNJQQVTBR8FTEH33QAL6D5ORQ0UDC24VCQKD740===="
