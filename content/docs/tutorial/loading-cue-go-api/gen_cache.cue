			...
			tutorial: {
				"loading-cue-go-api": {
					page: {
						cache: {
							upload: {
								"initial cue code": "+hnbhMXgRaDiud5AX7kks596L1dq0G2EhlYKZJoYaMs="
								"initial go code":  "uzu0VgZ3YsbpoRQmq4Aqq9sRyts0FzyT6uvIeQNhJ3E="
							}
							multi_step: {
								hash:       "PNAHG27QJTP5NHMMCE68B08M4EL2BOEPNE54TNTFD1RC6U6PS4CG===="
