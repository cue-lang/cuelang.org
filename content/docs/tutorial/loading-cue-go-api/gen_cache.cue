			...
			tutorial: {
				"loading-cue-go-api": {
					page: {
						cache: {
							upload: {
								"initial cue code": "T1i+RQum7M14W7UI9p4t64GesKXLqQ+nwIufeC9gHPk="
								"initial go code":  "oPqGkBxVBdXKpgtskMouxp1Qb+XvVVdG6KvK0LirUtg="
							}
							multi_step: {
								hash:       "N554MB1MC645270UID50GTNVI2FIBSOE62K3OR2M21V2NGGL8M8G===="
