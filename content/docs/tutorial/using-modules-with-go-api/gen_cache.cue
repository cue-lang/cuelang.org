			...
			tutorial: {
				"using-modules-with-go-api": {
					page: {
						cache: {
							upload: {
								"initial main.cue": "lhxTGl4+yYOS+u9lRSc9gUNphYtV8NvY/aG0KcpivOM="
								"initial go code":  "9Cco7hnjTZv+92jSrXhtvHJZEi5//K8mSbM9IOOjInQ="
							}
							multi_step: {
								hash:       "FGQHP4NOLH10K7QTMJE4TCD88QFPHTSVC1HMEFGMET5ROHCH9TI0===="
