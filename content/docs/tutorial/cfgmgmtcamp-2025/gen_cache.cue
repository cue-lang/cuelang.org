			...
			tutorial: {
				"cfgmgmtcamp-2025": {
					page: {
						cache: {
							upload: {
								"docker-compose.yml broken":          "nBv/jmH0YhokkSVvTyg3p9hcfAHST7YOeMcl7bvgqtc="
								schema:                               "6fnb7vf+X9a3fq5pSARl8XL2bBPfqpWmgh5t6MU7bk8="
								"docker-compose.yaml fixed":          "si6jb17/CNBPJZkqK+2OXqkgAZYt8S9NLiyoXxd1xHk="
								FIXME:                                "dxfJPefCc7xmf3eFCk0nVVnkod1cEApVFwuBe6v5+bg="
								"docker-compose.yaml really fixed":   "PZoccnmvGDL89i+HjHuG1xTfRuQ3stkBTb0oKZFdAeE="
								"link splotpolicy and splotservice1": "tvNgBJ8C+MNq7Q4ukXPlm0lCeLIID/O6CVIidJ4ZLWk="
							}
							multi_step: {
								hash:       "OD63BJ8OBSPJSAILC40BRJA2C4F3QANG1ROB98P312R6LFL6LDFG===="
								scriptHash: "VDODH76BBJBP58B7VA0BIV6KJ484AVVD05HCFJ3JTADH0SBHI8EG===="
								steps: [{
									doc:      ""
