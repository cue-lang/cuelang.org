			...
			tutorial: {
				"handle-errors-java-api": {
					page: {
						cache: {
							upload: {
								code: "OYh9J8SN+AxVwOzElzbXNYuAKdeQDroRq5/cOTCQUHA="
							}
							multi_step: {
								hash:       "R9JTP8TUC0K6PVA61SF8HHHF4QEIMMN0G6TN64VETAQVM0N8E36G===="
								scriptHash: "9HFNA2MH3H5PVVRTSVJ397LEMT1SIC975HNF8URTIG2R4CIP60MG===="
								steps: [{
									doc:      ""
