		...
		docs: {
			tutorial: {
				"validating-simple-yaml-files": {
					cache: {
						upload: {
							yamlBroken: "2jtssPxV7uD+udZdQgEEjC946Zendwt6TudXS3T0iW0="
							"pets.cue": "7S0ql8sX0d8ZrA8ThH8lqHFqyLEopmwgoxUMAqZmtxQ="
							yamlFixed:  "b1EBuD04fXEpdAlXeMMLmfWT1sp//Yn2OESSxdaS9LI="
							yaml2:      "XRIQCF6+bRoB38H5lZR7MG+SkiBbu8ZBYz0OkFkmyPg="
						}
						multi_step: {
