		...
		docs: {
			tutorial: {
				"validating-simple-yaml-files": {
					cache: {
						upload: {
							yamlBroken: "Gfv3w+grCFXHeood3NER0uU3rxGqn/XJD36wl8VkWTI="
							"pets.cue": "3KBHKBfyGTJIgTQ8WXS7eeY5olflS+ZH9lzoj+roDNo="
							yamlFixed:  "A0JyD6ZbCiVerhfEAPWd9wq6HXEVAJplqSPrbeJoHuc="
							yaml2:      "4DQNrHkoyTuVqb+Pt16UN47pTkQdVGbKItoHTuHqyyw="
						}
						multi_step: {
