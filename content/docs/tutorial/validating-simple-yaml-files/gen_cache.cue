		...
		docs: {
			tutorial: {
				"validating-simple-yaml-files": {
					cache: {
						upload: {
							yamlBroken: "BgqPIAHqdm+nUgiNfXBL8eAlJgq4pFcIRgCl6PH1XPQ="
							"pets.cue": "BbKUuPlpdfnAzhwJ9jNrZDgQdCm7iqEc834SvvSBnTk="
							yamlFixed:  "e28DReYHwtd+4ffJrzVabuU+zGVk8NqhgllubtLtdeo="
							yaml2:      "zHVROJHiIONkIf7G1yfN/3m5gKIfFpjJsncdNzqAPxg="
						}
						multi_step: {
