		...
		docs: {
			tutorial: {
				"validating-simple-yaml-files": {
					cache: {
						upload: {
							yamlBroken: "58Y9iJ0+Zd+aidhpJz50N2OiYRhFEu5h4bkdorREsbM="
							"pets.cue": "/zyS50eXITqh3Y8sGBxwqUiEZs3FzayuOMSsnz9RDqE="
							yamlFixed:  "ZHIpAhPVaAiC53TShMNRsp7gGk4o1BIUocyN+9VHMpY="
							yaml2:      "LDSXR9ZP6zd6vNV1Ls4jFiN0bPuAGqjQgs3jB64P6qE="
						}
						multi_step: {
