			...
			tutorial: {
				"validating-simple-yaml-files": {
					"_page": {
						cache: {
							upload: {
								yamlBroken: "nA/q1Ha4NBqAcuhDrntRaZbovLKLUbBL77x/oGvL2xQ="
								"pets.cue": "wrL0DDD9+wveVFWWev9Oy2NEDQVs9Wcze/CWv2GbLK8="
								yamlFixed:  "TqPRdkRx/5hF/t/yYzKZA6MNCczKZoj9MwjOt9hRvSg="
								yaml2:      "rbeQOxSQujfHz0xzdX76zDCGIEJtu9p0FMxwIHxuCRU="
							}
							multi_step: {
