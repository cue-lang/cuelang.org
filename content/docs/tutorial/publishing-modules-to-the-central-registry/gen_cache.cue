			...
			tutorial: {
				"publishing-modules-to-the-central-registry": {
					page: {
						cache: {
							upload: {
								"schema-v0.0.1": "712APseSo3ZzNVt99dGZrIqA+tSkuFCjQWMKMIaVR+U="
								"config.cue":    "b4VM4XG2AekLNdnW5/gQNcGtKtLhzTgbpRerrHZzXEs="
							}
							multi_step: {
								hash:       "K6ADJ70FR8BDLTJJ8DAJ2VIEKT5AKQS2MDAA17KFA4FTC7MRF4G0===="
