			...
			tutorial: {
				"publishing-modules-to-the-central-registry": {
					page: {
						cache: {
							upload: {
								"schema-v0.0.1": "x94DMuHmmiZTgR7drXNpk+tb8rtootgUYaunJLo09oI="
								"config.cue":    "Xc/cdjl1X7DdncNatDzHfGTSPW4j7rDintz5n8CAnz8="
							}
							multi_step: {
								hash:       "MEKGG3G5LRQLIBMSLT7PB0TUIEMKN4OCGUEAILH84D7FTEBIU080===="
