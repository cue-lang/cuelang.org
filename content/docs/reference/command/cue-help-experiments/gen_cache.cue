				...
				command: {
					"cue-help-experiments": {
						page: {
							cache: {
								multi_step: {
									hash:       "2997KNSTI4A430KRUDSBL17Q3URFJM61U104N0QLF2LFL7RS6F9G===="
									scriptHash: "QQQ3VT5AGNSPF72VGJ2RMBH1VUCE0B3HRSCFUE9OGSR2LIC7UAQG===="
									steps: [{
										doc:      ""
										cmd:      "export PATH=/cues/v0.15.0-alpha.1.0.20251008100148-dc3731d6d461:$PATH"
										exitCode: 0
										output:   ""
									}, {
										doc:      ""
