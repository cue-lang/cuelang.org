	...
	Create: {
		...
		"hugo/config/_default/params.toml": {
			...
			[notification]
			    ...
			    content = 'CUE \#(versions.cue.latest.majorDotMinor) contains some great new features -- check out [the release notes](https://github.com/cue-lang/cue/releases/tag/\#(versions.cue.latest.majorDotMinor).0) to learn more!'
			    [notification.button]
