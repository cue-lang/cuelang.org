...
//
// This is a verbatim copy of cuelang.org/go/internal/tdtest, which cannot be
// imported directly as it is internal to a different module. The only change
// is the set of receiver types recognised by isT in update.go.
package tdtest
