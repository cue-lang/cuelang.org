...
func main() {
	...
	fmt.Fprintf(&out, "// Code generated by internal/genversion. DO NOT EDIT.\n")
	fmt.Fprintf(&out, "\n")
	fmt.Fprintf(&out, "export const CUEVersion = '%v';\n", v)
	if err := os.WriteFile("gen_cuelang_org_go_version.ts", out.Bytes(), 0666); err != nil {
