...
{
    private workspaceIcon: string = this.props.activeWorkspace.icon;
            ...
            <header className="cue-header">
                <a href="/" className="cue-header__logo" rel="home">
                    <svg width="50" height="50" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path className="cue-header__logo-inner"
                              d="m 25.000283,3.74023 c -11.74,0 -21.26003,9.51997 -21.26003,21.25997 0,11.74 9.52003,21.26 21.26003,21.26 11.74,0 21.26,-9.52 21.26,-21.26 0,-11.74 -9.52,-21.25997 -21.26,-21.25997 z m 0,41.39997 c -11.12,0 -20.14003,-9.02 -20.14003,-20.14 0,-11.12 9.02003,-20.13997 20.14003,-20.13997 11.12,0 20.14,9.01997 20.14,20.13997 0,11.12 -9.02,20.14 -20.14,20.14 z"/>
                ...
                <div className="cue-header__section">
                    <Menu id="workspace"
                          icon={ this.workspaceIcon }
                          cssClass='cue-menu--wide'
                          type="icon-mobile"
                          title={ this.props.activeWorkspace.title }
                          open={ this.state.workspaceMenuOpen }
                          onOpen={ () => { this.setState({ workspaceMenuOpen: true} )}}
                    ...
                    >
                        <WorkspaceMenu
                           ...
                           activeFunc={ this.props.activeFunc }
                           activeOutput={ this.props.activeOutput }
