...
#   regenerating their content
# - for each cue subcommand listed below, it:
#   - creates a "cue-<subcommand>" directory
#   - places the output of "cue help <subcommand>" into a templated
#     "cue-<subcommand>/en.md"
#   - templates "cue-<subcommand>/page.cue"
#
# see the bottom of the file for the main function, its interface, and the
# script's interface.
...
function writeHelpText() {
    ...
    # cueBaseAddress will only be valiud CUE if cueBaseAddressAsPath contains
...
vet"
    ...
    # we create (and enforce the deletion of) a local cue.mod directory, to
    # stop "cue help cmd" from traversing the filesystem to the root of the
    ...
    writeHelpText "$contentRootAbsoluteSuffix" cue cue "go run cuelang.org/go/cmd/cue help" "cue help"
}
