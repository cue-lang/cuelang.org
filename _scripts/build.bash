...
then
    ...
    # Use a cache volume for this build. This does not mean that the cache
    # volume itself is cached between builds; merely that the volume is
    # present, and will be shared across the pages of the site to be used if
    # they experience a gen_cache.cue miss, or if the skipcache setting tells
    # the preprocessor not to use the contents of the gen_cache.cue files.
    nocachevolume=""
