...
rawTag=$(dockerImageHash)
# FIXME: don't hardcode GOPRIVATE
nscBuildArgs="--name preprocessor-test:$rawTag --build-arg GOPRIVATE= -f ./_docker/Dockerfile ./_docker"

nsc build --push $nscBuildArgs
