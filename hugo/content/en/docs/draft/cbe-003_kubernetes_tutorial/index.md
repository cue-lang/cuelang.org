...
{{< code-tabs >}}
{{< code-tab name="tmp/services/k8s_defs.cue" language="cue" area="top-left" >}}
package kube
...
```text { title="TERMINAL" type="terminal" codeToCopy="Y3VlIG1vZCB0aWR5CmN1ZSBmbXQKY3VlIHZldCAtYyAuLy4uLg==" }
$ cue mod tidy
$ cue fmt
$ cue vet -c ./...
```
