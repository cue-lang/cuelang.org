...
Declare a Buildkite pipeline in CUE. This one is based on an example from
[Buildkite's documentation](https://buildkite.com/platform/pipelines/templates/cd/aws-ecs-deploy/):
