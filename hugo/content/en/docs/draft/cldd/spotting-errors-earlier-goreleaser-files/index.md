...
``` { .shell-session title="TERMINAL" data-copy="cue vet -c -d &#39;#Project&#39; cue.dev/x/goreleaser@latest .goreleaser.yml" }
...
``` { .yml title=".goreleaser.yml" hl_lines=9 }
project_name: example
builds:
  - goos: [ linux, windows, darwin ]
    goarch: [ amd64, arm64 ]
