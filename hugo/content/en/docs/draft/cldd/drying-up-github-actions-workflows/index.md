...
```cue { title="ci/github/release.cue" codeToCopy="" }
// filepath: ci/github/release.cue
...
workflows: release: {
	...
	jobs: release: {
		steps: [
			...
			_setupGo,
			_installGoDependencies,
			// The release workflow needs to specify the slower, safer "-race" flag for "go test",
