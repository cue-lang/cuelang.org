...
For each command that contains the example username `cueckoo`,
...
This CUE needs to live in the file `frostyconfig/config.cue`:
...
```cue { title="frostyapp/config.cue" codeToCopy="" hl_lines=6 }
