...
```text { title="TERMINAL" codeToCopy="Y2Qgc2VydmljZXM=" }
$ cd services
```
...
```text { title="TERMINAL" codeToCopy="Y3VlIGltcG9ydCAuLy4uLiAtcCBrdWJl" }
$ cue import ./... -p kube
...
```text { title="TERMINAL" codeToCopy="ZmluZCAuIHwgZ3JlcCBrdWJlLmN1ZSB8IHhhcmdzIHdjIC1sIHwgdGFpbCAtMQpjdWUgdHJpbSAuLy4uLgpmaW5kIC4gfCBncmVwIGt1YmUuY3VlIHwgeGFyZ3Mgd2MgLWwgfCB0YWlsIC0x" }
...
-->
||||||| parent of 9bc1a77e (site: revert to previous min versions of CUE)
=======
---
title: K8s tutorial
draft: true
...
$ cue eval -c ./... >snapshot2
$ diff -wu snapshot snapshot2
--- snapshot	2024-04-24 11:01:11.375778482 +0000
+++ snapshot2	2024-04-24 11:01:12.919779325 +0000
@@ -1,3 +1,9 @@
+service: {}
+deployment: {}
+// ---
...
$ cue eval -c ./... >snapshot2
$ diff -wu snapshot snapshot2
--- snapshot	2024-04-24 11:01:21.211783845 +0000
+++ snapshot2	2024-04-24 11:01:22.443784515 +0000
@@ -190,6 +190,7 @@
                 metadata: {
                     annotations: {
                         "prometheus.io.scrape": "true"
...
## Conversion to `docker-compose`
-->
>>>>>>> 9bc1a77e (site: revert to previous min versions of CUE)
