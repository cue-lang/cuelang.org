...
to a private OCI-compatible artifact registry and to consume modules
from such a registry.

Along the way, you will:

- Define a schema inside a module
- Push modules to a registry
- Use modules to consume dependencies from a registry
...
See the [Validating simple YAML files](./validating-simple-yaml-files) tutorial for guidance on installing
the CUE command.
...
Create a schema for this application in its own directory:
...
```text { title="TERMINAL" codeToCopy="Y2QgLi4vZnJvc3R5dGVtcGxhdGUKY3VlIG1vZCBpbml0IGdpdGh1Yi5jb20vZ2xhY2lhbC10ZWNoL2Zyb3N0eXRlbXBsYXRlQHYwCmN1ZSBtb2QgdGlkeQpjdWUgbW9kIHB1Ymxpc2ggdjAuMC4xCg==" }
$ cd ../frostytemplate
$ cue mod init github.com/glacial-tech/frostytemplate@v0
$ cue mod tidy
$ cue mod publish v0.0.1
```
{{< /step >}}
