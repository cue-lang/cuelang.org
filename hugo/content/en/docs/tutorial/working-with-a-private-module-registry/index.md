...
```text { title="TERMINAL" codeToCopy="I25vcnVuCmNkIGZyb3N0eWNvbmZpZwpjdWUgbW9kIGluaXQgZ2l0aHViLmNvbS9nbGFjaWFsLXRlY2gvZnJvc3R5Y29uZmlnQHYwCg==" }
$ #norun
cd frostyconfig
...
```text { title="TERMINAL" codeToCopy="I25vcnVuCmRvY2tlciBydW4gLXAgNTAwMDo1MDAwIHJlZ2lzdHJ5Cg==" }
$ #norun
...
```text { title="TERMINAL" codeToCopy="I25vcnVuCmV4cG9ydCBDVUVfRVhQRVJJTUVOVD1tb2R1bGVzCmV4cG9ydCBDVUVfUkVHSVNUUlk9bG9jYWxob3N0OjUwMDAvY3VlbW9kdWxlcwpjdWUgbW9kIHRpZHkKY3VlIHB1Ymxpc2ggdjAuMC4xCg==" }
$ #norun
...
```text { title="TERMINAL" codeToCopy="I25vcnVuCmNkIC4uL2Zyb3N0eWFwcApjdWUgbW9kIHRpZHkK" }
$ #norun
cd ../frostyapp
$ cue mod tidy
```
...
```text { title="TERMINAL" codeToCopy="I25vcnVuCmN1ZSB2ZXQgLWMKY3VlIGV4cG9ydCAtLW91dCB5YW1sIC4K" }
$ #norun
cue vet -c
$ cue export --out yaml .
```
...
```text { title="TERMINAL" codeToCopy="I25vcnVuCmNkIC4uL2Zyb3N0eXRlbXBsYXRlCmN1ZSBtb2QgdGlkeQpjdWUgcHVibGlzaCB2MC4wLjEK" }
$ #norun
cd ../frostytemplate
$ cue mod tidy
$ cue publish v0.0.1
...
```text { title="TERMINAL" codeToCopy="I25vcnVuCmN1ZSBtb2QgdGlkeQpjdWUgZXhwb3J0IC4K" }
$ #norun
cue mod tidy
$ cue export .
```
...
```text { title="TERMINAL" codeToCopy="I25vcnVuCmNkIC4uL2Zyb3N0eWNvbmZpZwpjdWUgbW9kIHRpZHkKY3VlIG1vZCBwdWJsaXNoIHYwLjAuMgo=" }
$ #norun
cd ../frostyconfig
$ cue mod tidy
...
```text { title="TERMINAL" codeToCopy="I25vcnVuCmN1ZSBtb2QgdGlkeQpjdWUgZXhwb3J0IC0tb3V0IHlhbWwK" }
$ #norun
cue mod tidy
$ cue export --out yaml
```
