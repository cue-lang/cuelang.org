...
```text { title="TERMINAL" codeToCopy="Y3VlIGltcG9ydCAtcCB2YWxpZGF0ZSBleGFtcGxlLnlhbWwgLWwgU2NoZW1hOiAtbyBzY2hlbWEuY3VlIC1mCg==" }
...
```text { title="TERMINAL" codeToCopy="Y2F0IHNjaGVtYS5jdWUK" }
$ cat schema.cue
package validate
...
```text { title="TERMINAL" codeToCopy="Y3VlIHZldCBzY2hlbWEuY3VlIGV4YW1wbGUueWFtbCAtZCBTY2hlbWEK" }
