...
required by GitHub Actions means that you will catch and fix structural
mistakes in your workflows earlier than before, without waiting for the slow
...
$ git add -p .github/workflows/ internal/ci/github/
[ ... ]
$ git commit -m "ci: include XYZ in the ABC workflow"
```
