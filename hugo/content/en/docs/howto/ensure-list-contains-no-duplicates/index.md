...
version then you can replace the call to the `error(...)` builtin with a string
value. This causes an evaluation failure, and indirectly displays the value as
part of the failure's error message:
