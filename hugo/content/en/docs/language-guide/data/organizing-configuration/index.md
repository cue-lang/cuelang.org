...
{{< code-tabs >}}
{{< code-tab name="fruit.cue" language="txt"  area="top-left" >}}
package food
...
{{< /code-tab >}}
{{< code-tab name="vegetables.cue" language="txt"  area="bottom-left" >}}
package food

cart: spinach: 4
{{< /code-tab >}}
{{< code-tab name="TERMINAL" language="txt" type="terminal" area="top-right" >}}
cart: {
	apples:  1
	oranges: 3
	spinach: 4
