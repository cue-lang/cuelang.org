...
A: 42
{{< /code-tab >}}
{{< code-tab name="TERMINAL" language="" area="bottom" type="terminal" codetocopy="Y3VlIHZldCAuL2RpcjpiZXRhICMgcGFja2FnZSAuL2RpcjphbHBoYSBpc24ndCBjaGVja2VkLCBzbyB0aGlzIHN1Y2NlZWRz" >}}
$ cue vet ./dir:beta # package ./dir:alpha isn't checked, so this succeeds
{{< /code-tab >}}
{{< /code-tabs >}}
