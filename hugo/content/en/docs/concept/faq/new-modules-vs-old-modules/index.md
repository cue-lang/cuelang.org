...
toc_hide: false
summary: |
  Frequently Asked Questions (FAQ) with answers about the differences between
  CUE's old modules implementation, and its new modules implementation that
  became the default with CUE v0.9.0.
---
