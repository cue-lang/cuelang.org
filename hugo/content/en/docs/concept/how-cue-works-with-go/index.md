...
````text { title="TERMINAL" type="terminal" codeToCopy="Z28gZ2V0IGN1ZWxhbmcub3JnL2dvQHYwLjE2LjAKZ28gbW9kIHRpZHk=" }
$ go get cuelang.org/go@v0.16.0
...
$ go mod tidy
...
````
...
````text { title="TERMINAL" type="terminal" codeToCopy="Z28gZ2V0IGN1ZWxhbmcub3JnL2dvQHYwLjE2LjAKZ28gbW9kIHRpZHkKZ28gcnVuIC4=" }
$ go get cuelang.org/go@v0.16.0
...
$ go mod tidy
...
