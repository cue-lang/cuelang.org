...
```text { title="TERMINAL" codeToCopy="Z28gZ2V0IGN1ZWxhbmcub3JnL2dvQHYwLjkuMC1hbHBoYS4zCmdvIG1vZCB0aWR5CmdvIHJ1biAu" }
$ go get cuelang.org/go@v0.9.0-alpha.3
...
$ go mod tidy
...
...
- Go API: [`cue/load`](https://pkg.go.dev/cuelang.org/go/cue/load)
  and     [`cue/context`](https://pkg.go.dev/cuelang.org/go/cue/context)
- Go API: [`encoding/yaml`](https://pkg.go.dev/cuelang.org/go/encoding/yaml)
  and     [`encoding/json`](https://pkg.go.dev/cuelang.org/go/encoding/json)
- CUE By Example:
  [Controlling Kubernetes with CUE](https://github.com/cue-labs/cue-by-example/blob/main/003_kubernetes_tutorial/README.md)
