...
```text { title="TERMINAL" type="terminal" codeToCopy="Z28gZ2V0IGN1ZWxhbmcub3JnL2dvQHYwLjE0LjAtYWxwaGEuMQpnbyBtb2QgdGlkeQ==" }
$ go get cuelang.org/go@v0.14.0-alpha.1
...
$ go mod tidy
...
```
...
```text { title="TERMINAL" type="terminal" codeToCopy="Z28gZ2V0IGN1ZWxhbmcub3JnL2dvQHYwLjE0LjAtYWxwaGEuMQpnbyBtb2QgdGlkeQpnbyBydW4gLg==" }
$ go get cuelang.org/go@v0.14.0-alpha.1
...
$ go mod tidy
...
