...
```text { title="TERMINAL" type="terminal" codeToCopy="Z28gZ2V0IGN1ZWxhbmcub3JnL2dvQHYwLjEyLjAtYWxwaGEuMQpnbyBtb2QgdGlkeQ==" }
$ go get cuelang.org/go@v0.12.0-alpha.1
...
$ go mod tidy
...
```
...
```text { title="TERMINAL" type="terminal" codeToCopy="Z28gZ2V0IGN1ZWxhbmcub3JnL2dvQHYwLjEyLjAtYWxwaGEuMQpnbyBtb2QgdGlkeQpnbyBydW4gLg==" }
$ go get cuelang.org/go@v0.12.0-alpha.1
...
$ go mod tidy
...
