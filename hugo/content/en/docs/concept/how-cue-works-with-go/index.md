...
```text { title="TERMINAL" type="terminal" codeToCopy="Z28gZ2V0IGN1ZWxhbmcub3JnL2dvQHYwLjEzLjAtYWxwaGEuMwpnbyBtb2QgdGlkeQ==" }
$ go get cuelang.org/go@v0.13.0-alpha.3
...
$ go mod tidy
...
```
...
```text { title="TERMINAL" type="terminal" codeToCopy="Z28gZ2V0IGN1ZWxhbmcub3JnL2dvQHYwLjEzLjAtYWxwaGEuMwpnbyBtb2QgdGlkeQpnbyBydW4gLg==" }
$ go get cuelang.org/go@v0.13.0-alpha.3
...
$ go mod tidy
...
