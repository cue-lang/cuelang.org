...
```text { title="TERMINAL" type="terminal" codeToCopy="Z28gZ2V0IGN1ZWxhbmcub3JnL2dvQHYwLjEyLjAtMC5kZXYuMC4yMDI0MTIwODEwMDcwOC00MzJjMTE0MWU2ZTcKZ28gbW9kIHRpZHk=" }
$ go get cuelang.org/go@v0.12.0-0.dev.0.20241208100708-432c1141e6e7
...
$ go mod tidy
...
```
...
```text { title="TERMINAL" type="terminal" codeToCopy="Z28gZ2V0IGN1ZWxhbmcub3JnL2dvQHYwLjEyLjAtMC5kZXYuMC4yMDI0MTIwODEwMDcwOC00MzJjMTE0MWU2ZTcKZ28gbW9kIHRpZHkKZ28gcnVuIC4=" }
$ go get cuelang.org/go@v0.12.0-0.dev.0.20241208100708-432c1141e6e7
...
$ go mod tidy
...
