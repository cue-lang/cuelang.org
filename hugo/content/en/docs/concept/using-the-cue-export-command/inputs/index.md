...
- CUE files that do *not* have a `package` clause near the top
  (a "**<u style='text-decoration-style: dotted;'>package-less CUE file</u>**")
- Non-CUE data files
...
single <u style='text-decoration-style: dotted;'>CUE package</u> input. The <u style='text-decoration-style: dotted;'>CUE package</u> input must be the first input
...
<u style='text-decoration-style: dotted;'>CUE package file</u> and <u style='text-decoration-style: dotted;'>package-less CUE file</u> inputs contribute data and
...
A <u style='text-decoration-style: dotted;'>package-less CUE file</u> input (a CUE file that doesn't contain a package
...
that's [demonstrated below](#non-cue-data-path).
...
<u style='text-decoration-style: dotted;'>Data file</u> inputs contain concrete data, encoded as JSON, YAML or TOML.
...
<u style='text-decoration-style: dotted;'>CUE package file</u> or <u style='text-decoration-style: dotted;'>package-less CUE file</u> input, depending if the stream
...
space. You can change this behaviour by specifying a static or dynamic path
...
To specify a static path for the <u style='text-decoration-style: dotted;'>data file</u> inputs during evaluation,
...
Increase the depth and nesting of the path by adding more components to the
expression:
...
The list of `--path` (`-l`) flags in the order they're specified defines the
path where non-CUE data is placed. It doesn't matter where the flags are placed
relative to other flags or arguments.

When specifying a static path the data in all non-CUE <u style='text-decoration-style: dotted;'>data file</u> inputs is
unified at that single path.
...
specify dynamic paths -- as demonstrated in the next section.

### Dynamic paths

As you saw in the previous section, a trailing colon (`:`) tells `cue export`
that a value in the path expression should be interpreted statically.
