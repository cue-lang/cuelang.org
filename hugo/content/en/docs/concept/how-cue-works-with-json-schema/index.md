...
{{< /code-tab >}}
{{< code-tab name="TERMINAL" language="" area="top-right" type="terminal" codetocopy="Y3VlIGltcG9ydCBqc29uc2NoZW1hOiBzY2hlbWEuanNvbiAtbyAt" >}}
$ cue import jsonschema: schema.json -o -
import "strings"
