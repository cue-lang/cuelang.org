...
```` { .text title="TERMINAL" data-copy="go get k8s.io/api/apps/v1@v0.29.3" }
...
```` { .text title="TERMINAL" data-copy="tree -d cue.mod/gen/k8s.io" }
...
```` { .text title="TERMINAL" data-copy="cue eval" }
$ cue eval
service: {}
deployment: {}
daemonSet: {}
