...
```` { .text title="TERMINAL" data-copy="find ./original -type f | sort" }
...
```` { .text title="TERMINAL" data-copy="cp -a original tmp&#10;cd tmp" }
$ cp -a original tmp
$ cd tmp
````
...
```` { .text title="TERMINAL" data-copy="cue mod init k8s.example" }
...
```` { .text title="TERMINAL" data-copy="go mod init k8s.example" }
...
```` { .text title="TERMINAL" data-copy="cd services" }
$ cd services
````
...
```` { .text title="TERMINAL" data-copy="cue import ./... -p kube" }
$ cue import ./... -p kube
...
```` { .text title="TERMINAL" data-copy="cue import ./... -p kube -l &#39;strings.ToCamel(kind)&#39; -l metadata.name -f" }
...
```` { .text title="TERMINAL" data-copy="find . -type f | sort" }
$ find . -type f | sort
...
```` { .text title="TERMINAL" data-copy="head mon/prometheus/configmap.cue" }
...
```` { .text title="TERMINAL" data-copy="cue import ./... -p kube -l &#39;strings.ToCamel(kind)&#39; -l metadata.name -f -R" }
...
```` { .text title="TERMINAL" data-copy="cue eval ./mon/prometheus -e configMap.prometheus" }
...
```` { .text title="TERMINAL" data-copy="cue eval -c ./... &gt;snapshot" }
$ cue eval -c ./... >snapshot
````
...
```` { .text title="TERMINAL" data-copy="cp frontend/breaddispatcher/kube.cue ." }
...
```` { .text title="TERMINAL" data-copy="cue eval -c ./... &gt;snapshot2" }
...
```` { .text title="TERMINAL" data-copy="sed -i.bak &#39;s/component:.*string/component: #Component/&#39; kube.cue&#10;rm kube.cue.bak&#10;cat &lt;&lt;EOF &gt;&gt;kube.cue&#10;&#10;#Component: string&#10;EOF&#10;ls -d */ | sed &#39;s/.$//&#39; | xargs -I DIR sh -c &#39;cd DIR; echo &#34;package kube&#10;&#10;#Component: \\&#34;DIR\\&#34;&#10;&#34; &gt; kube.cue; cd ..&#39;&#10;cue fmt kube.cue */kube.cue" }
...
```` { .text title="TERMINAL" data-copy="cp snapshot2 snapshot" }
...
```` { .text title="TERMINAL" data-copy="find . | grep kube.cue | xargs wc -l | tail -1&#10;cue trim ./...&#10;find . | grep kube.cue | xargs wc -l | tail -1" }
$ find . | grep kube.cue | xargs wc -l | tail -1
 1833 total
$ cue trim ./...
$ find . | grep kube.cue | xargs wc -l | tail -1
...
```` { .text title="TERMINAL" data-copy="cue trim ./...&#10;find . | grep kube.cue | xargs wc -l | tail -1" }
$ cue trim ./...
$ find . | grep kube.cue | xargs wc -l | tail -1
 1212 total
````
...
```` { .text title="TERMINAL" data-copy="head frontend/breaddispatcher/kube.cue" }
...
```` { .text title="TERMINAL" data-copy="cue trim ./... -s&#10;head frontend/breaddispatcher/kube.cue" }
$ cue trim ./... -s
$ head frontend/breaddispatcher/kube.cue
package kube
...
```` { .text title="TERMINAL" data-copy="cue trim ./frontend/... -s&#10;find . | grep kube.cue | xargs wc -l | tail -1" }
$ cue trim ./frontend/... -s
$ find . | grep kube.cue | xargs wc -l | tail -1
 1005 total
````
...
```` { .text title="TERMINAL" data-copy="cue trim -s ./kitchen/...&#10;cue eval -c ./... &gt;snapshot2&#10;diff -wu snapshot snapshot2 --label snapshot --label snapshot2&#10;cp snapshot2 snapshot&#10;find . | grep kube.cue | xargs wc -l | tail -1" }
$ cue trim -s ./kitchen/...
...
```` { .text title="TERMINAL" data-copy="cue cmd ls ./frontend/maitred" }
...
```` { .text title="TERMINAL" data-copy="cue cmd ls ./..." }
$ cue cmd ls ./...
...
```` { .text title="TERMINAL" data-copy="cue cmd create ./frontend/..." }
