...
```` { .text title="TERMINAL" data-copy="brew install cue-lang/tap/cue" }
...
```` { .text title="TERMINAL" data-copy="docker pull cuelang/cue:latest" }
...
```` { .text title="TERMINAL" data-copy="go install cuelang.org/go/cmd/cue@latest" }
...
```` { .text title="TERMINAL" data-copy="go install cuelang.org/go/cmd/cue@master" }
...
```` { .text title="TERMINAL" data-copy="pacman -S extra/cue" }
$ pacman -S extra/cue
````
...
```` { .text title="TERMINAL" data-copy="go get cuelang.org/go@latest" }
