...
// single argument, a time.Duration that can be parsed by time.ParseDuration,
// and sleeps for that length of time. If no duration is passed then a sensible
// default value is used, a default that works in "most" situations.
