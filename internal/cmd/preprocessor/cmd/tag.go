...
const (
	...
	// tagAssert indicates that an upload node should ensure the contents of
	// files on disk match those specified. The --update flag allows for the
	// upload node using the #assert directive to be updated to reflect the
