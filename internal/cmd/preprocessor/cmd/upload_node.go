...
type uploadNode struct {
	...
	// deliniate the start and end of the on-disk file contents. This slice is
	// populated in the case that we see the #assert directive and are running
	// with --update. Because in this case we need to update the upload node
	// with the actual on-disk contents, and the fences capture that output.
