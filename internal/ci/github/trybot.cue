...
workflows: trybot: _repo.bashWorkflow & {
	...
	jobs: test: {
		...
		steps: [
			...
			// Download all CUE dependencies, so that only this step needs to be
			// given (read-only) access to the Central Registry via
			// NOTCUECKOO_CUE_LOGINS.
			// TODO: adopt whatever command results from https://cuelang.org/issue/3512.
			githubactions.#Step & {
