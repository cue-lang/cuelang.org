...
workflows: trybot: _repo.bashWorkflow & {
	...
	jobs: test: {
		...
		steps: [
			...
			// protected branches) does not the Preprocessor-No-Write-Cache
			// trailer. Such a state would be a serious problem; i.e. we have
			// somehow ended up with an errant commit in the default branch,
			// when they should only ever exist as an ephemeral artefact in the
			// trybot trigger.
			{
