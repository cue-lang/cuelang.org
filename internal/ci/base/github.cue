...
// dispatchTrailerExpr is an expression which evaluates to the decoded JSON value
// of the dispatchTrailer if it exists, or null otherwise.
dispatchTrailerExpr: "fromJSON(steps.\(dispatchTrailerStepID).outputs.value)"
